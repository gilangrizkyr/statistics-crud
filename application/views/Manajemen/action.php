...
<body>
    <div class="container">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <?php
                $karyawan = array_reverse($karyawan);
                $no = 1;
                foreach ($karyawan as $data): ?>
                    <tr>
                        ...
                        <td><?= $data['jabatan']; ?></td>
                        <td>
                            <button class="btn btn-success" data-toggle="modal" data-target="#editKaryawanModal<?= $data['id']; ?>">Edit</button>
                            <a href="<?= base_url('action/delete/' . $data['id']); ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</a>
                        </td>
                    </tr>
    ...
    <!-- Include JS untuk Bootstrap dan jQuery -->
    <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js"></script>
